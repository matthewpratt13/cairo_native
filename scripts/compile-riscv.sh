...
"$MLIR_SYS_180_PREFIX"/bin/clang --sysroot=/usr/local/opt/riscv-gnu-toolchain/riscv64-unknown-elf --gcc-toolchain=/usr/local/opt/riscv-gnu-toolchain --target=riscv64 -fuse-ld=lld -march=rv64gc -mabi=lp64d -lc -lm ./tmp/output.o -o output -v
